...
WINGHOME = r"C:\Program Files\Wing Pro 11"
...
if (not kWingDebugDisabled and debugger is None and
  ...
  try:
    ...
    #  Create an error stream, write temp log messages, and find the netserver module
    from debug.tserver import startdebug
    
    err = startdebug.CreateErrStream(None, logfile, very_verbose_log)
